 ...
 * is available, timeout is reached (which may be never in paused simulation), time jumps backwards or rclcpp::ok() returns
 ...
 */
class InterruptibleTFBuffer : protected ::tf2_ros::Buffer, public ::compass_utils::InterruptibleSleepInterface
{
public:
  /**
   ...
   */
  explicit InterruptibleTFBuffer(const rclcpp::Clock& clock, const ::tf2::Duration& cacheTime = {::tf2::BUFFER_CORE_DEFAULT_CACHE_TIME});//std::chrono::duration_cast<std::chrono::duration<int32_t>>(::tf2::BUFFER_CORE_DEFAULT_CACHE_TIME).count()});
   ...
   */
  explicit InterruptibleTFBuffer(const ::std::shared_ptr<::tf2::BufferCore>& parentBuffer, const rclcpp::Clock& clock);
  ...
  bool canTransform(const ::std::string& target_frame, const ::std::string& source_frame,
    const ::tf2::TimePoint& time, ::tf2::Duration timeout, ::std::string* errstr) const override;
   ...
   */
  bool canTransform(const ::std::string& target_frame, const ::std::string& source_frame,
    const ::tf2::TimePoint& time, ::tf2::Duration timeout) const;

  bool canTransform(const ::std::string& target_frame, const ::tf2::TimePoint& target_time,
    const ::std::string& source_frame, const ::tf2::TimePoint& source_time,
    const ::std::string& fixed_frame, ::tf2::Duration timeout,
  ...
  bool canTransform(const ::std::string& target_frame, const ::tf2::TimePoint& target_time,
    const ::std::string& source_frame, const ::tf2::TimePoint& source_time,
    const ::std::string& fixed_frame, ::tf2::Duration timeout) const;

  ::geometry_msgs::msg::TransformStamped lookupTransform(
    const ::std::string& target_frame, const ::std::string& source_frame,
    const ::tf2::TimePoint& time, const ::tf2::Duration timeout) const override;  // NOLINT

  ::geometry_msgs::msg::TransformStamped lookupTransform(
    const ::std::string& target_frame, const ::tf2::TimePoint& target_time,
    const ::std::string& source_frame, const ::tf2::TimePoint& source_time,
    const ::std::string& fixed_frame, const ::tf2::Duration timeout) const override;  // NOLINT
   ...
   */
  bool setMinPollingDuration(const ::tf2::Duration& duration);
   ...
   */
  template <class T>
  T& transform(const T& in, T& out, const ::std::string& target_frame, ::tf2::Duration timeout = {0, 0}) const
  {
   ...
   */
  template <class T>
  T transform(const T& in, const ::std::string& target_frame, ::tf2::Duration timeout = {0, 0}) const
  {
    T out;
  ...
  B& transform(const A& in, B& out, const ::std::string& target_frame, ::tf2::Duration timeout = {0, 0}) const
  {
    return ::tf2_ros::Buffer::transform(in, out, target_frame, timeout);
  }
   ...
   */
  template <class T>
  T& transform(const T& in, T& out, const ::std::string& target_frame, const ::tf2::TimePoint& target_time,
    const ::std::string& fixed_frame, ::tf2::Duration timeout = {0, 0}) const
  {
   ...
   */
  template <class T>
  T transform(const T& in, const ::std::string& target_frame, const ::tf2::TimePoint& target_time,
    const ::std::string& fixed_frame, ::tf2::Duration timeout = {0, 0}) const
  {
   ...
   */
  template <class A, class B>
  B& transform(const A& in, B& out, const ::std::string& target_frame, const ::tf2::TimePoint& target_time,
    const ::std::string& fixed_frame, ::tf2::Duration timeout = {0, 0}) const
  {
  ...
  ::geometry_msgs::msg::TransformStamped lookupTransform(const ::std::string& target_frame,
    const ::std::string& source_frame, const ::tf2::TimePoint& time) const;
   ...
   *         tf2::InvalidArgumentException
   */
  ::geometry_msgs::msg::TransformStamped lookupTransform(const ::std::string& target_frame, const ::tf2::TimePoint& target_time,
    const ::std::string& source_frame, const ::tf2::TimePoint& source_time, const ::std::string& fixed_frame) const;
   ...
   * \return True if the transform is possible, false otherwise.
   */
  bool canTransform(const ::std::string& target_frame, const ::std::string& source_frame, const ::tf2::TimePoint& time,
   ...
   */
  bool canTransform(const ::std::string& target_frame, const ::tf2::TimePoint& target_time,
    const ::std::string& source_frame, const ::tf2::TimePoint& source_time, const ::std::string& fixed_frame,
    ::std::string* error_msg = nullptr) const;

  /**
   * \brief A way to see what frames have been cached in yaml format. Useful for debugging tools.
   */
  ::std::string allFramesAsYAML(tf2::TimePoint current_time) const;
...
protected:
  ...
  ::tf2::Duration minPollingDuration {std::chrono::nanoseconds(1000000)};
...
private:
  ...
  const ::std::shared_ptr<::compass_utils::InterruptibleTFBuffer> interruptibleParentBuffer {nullptr};
  ...
  mutable ::compass_utils::ReverseSemaphore callbackSemaphore;
};
