...
{
public:
  InterruptibleSleepInterface(const rclcpp::Clock& clock);
   ...
   */
  virtual bool sleep(const ::rclcpp::Duration& duration) const;
...
protected:
  ...
  ::rclcpp::Duration pollDuration {0, 1000000}; //WallDuration
